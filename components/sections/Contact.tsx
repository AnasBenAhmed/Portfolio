        ...
        <div className="grid grid-cols-1 gap-20 lg:grid-cols-2">
          ...
          <div>
            ...
            <div data-reveal className="mt-10 space-y-5">
              ...
              >
                <div className="flex h-10 w-10 shrink-0 items-center justify-center border border-crimson/40 text-crimson transition-all duration-300 group-hover:bg-crimson group-hover:border-crimson">
